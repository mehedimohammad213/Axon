...
const AdminListHeader = ({
  ...
  const countText =
    typeof itemCount === "number"
      ? itemCount === 1
        ? countLabel?.singular || "Item"
        : countLabel?.plural || "Items"
      : null;
    ...
    <div className="space-y-4">
        ...
        <div className="flex flex-col items-start justify-between gap-4 lg:flex-row lg:items-center">
          <div className="flex items-center gap-4">
            <div className="rounded-xl border border-gray-200 bg-brand-light p-3">
              <Image src={iconSrc} width={28} height={28} alt={iconAlt || title} />
            </div>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm sm:p-5">
        <div className="flex flex-col items-stretch justify-between gap-4 lg:flex-row lg:items-center">
          <div className="flex flex-wrap items-center gap-4">
            ...
            {showFilter && applyFilters && resetFilters && (
              <Button
                icon={<FilterOutlined />}
      ...
      {showFilter && applyFilters && resetFilters && (
        ...
        >
          ...
          >
            {renderFilterFields?.({ filterOptions })}
