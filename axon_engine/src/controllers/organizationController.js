...
const updateRole = asyncHandler(async (req, res) => {
  return sendServiceResult(res, await OrganizationService.updateRole(req.user, req.params.id, req.params.roleId, req.body));
});
...
const updateUser = asyncHandler(async (req, res) => {
  return sendServiceResult(res, await OrganizationService.updateUser(req.user, req.params.id, req.params.userId, req.body));
});
...
module.exports = {
  index, show, store, update, destroy, roleTemplates, regenerateSiteKey,
  roles, storeRole, updateRole, destroyRole,
  users, storeUser, updateUser, destroyUser,
};
